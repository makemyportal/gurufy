...
const translations = {
  english: {
    ...
    heroDesc: 'Connect with educators across the nation. Share resources, discover new opportunities, and elevate your teaching journey together.',
  ...
  hindi: {
    ...
    heroDesc: 'देश भर के शिक्षकों से जुड़ें। संसाधन साझा करें, नए अवसर खोजें और अपनी शिक्षण यात्रा को एक साथ बेहतर बनाएं।',
