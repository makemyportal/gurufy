...
import {
  ...
  Heart, MessageCircle, UserPlus, Zap, Trophy, Flame
} from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-surface-50 text-surface-900 selection:bg-primary-100 selection:text-primary-800 font-sans overflow-x-hidden">
      ...
      <div className="flex max-w-[1800px] mx-auto pt-[70px]">
        ...
        <aside className="hidden xl:block w-[280px] shrink-0 fixed top-[70px] bottom-0 left-0 bg-white/90 backdrop-blur-md border-r border-surface-200/80 z-40 overflow-y-auto no-scrollbar">
